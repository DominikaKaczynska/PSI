...
#Powy¿ej wykonano instalacjê pakietu
library(readxl)
#Wczytanie wybranego pakietu
...
# W ramce danych kraje_2 sprawdzenie typu zmiennej Region: 
...
# Czyszczenie danych ----
# Znalezienie "&" i zamiana na "and" (znak "&" bywa problematyczny):
...
kraje$Nazwa = NULL
# Zobaczenie ramki danych po scaleniu
summary(kraje)
str(kraje)
...
library(dplyr)
#Zainstalowanie i wczytanie pakietu "dplyr"
